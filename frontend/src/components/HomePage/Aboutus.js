        ...
        <div id="about" style={{ padding: '2rem' }}>
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={6}>
                    ...
                    >
                        SafetyNet is a comprehensive industrial safety and 
                        surveillance system designed to enhance workplace safety 
                        and security. It uses advanced computer vision and machine 
                        learning algorithms to monitor worker compliance, detect 
                        signs of fire, and recognize distress signals.
                    </Typography>
                </Grid>
            </Grid>
